...
// to put in.
type UnsanitizedNumber = { value: number, kind: 'unsanitized-number' }
type SanitizedNumber = { value: number, kind: 'sanitized-number' }
type InvalidNumber = { kind: 'invalid-number' }
